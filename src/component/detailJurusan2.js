import foto from './foto/dokter1.jpg'
import foto1 from './foto/peneliti.jpg'
import foto2 from './foto/epidemiologi.jpg'
import foto3 from './foto/manajer.jpg'
import fotoj from './foto/gizi.jpg'
import fotoj1 from './foto/kesmes.jpg'
import fotoj2 from './foto/farmasi.jpg'
import fotoj3 from './foto/keperawatan.jpg'
import fotok from './foto/LogoUPI.png'
import fotok1 from './foto/LogoUNPAD.png'
import fotok2 from './foto/LogoUI.png'
import fotok3 from './foto/LogoUGM.png'

function DetailJurusan2() {
    return (
        <div class="bg-gray-100 h-full  ">
            <section class="bg-gray-100 w-full h-screen bg-[url('./component/foto/Dokter.png')] bg-[length:1300px_790px] bg-no-repeat overflow-hidden ">
                ...
                <div class="grid grid-rows-2 justify-center mt-20">
                    <div class="inline-flex space-x-4 items-center mx-auto">
                        ...
                        <p class="text-5xl font-bold leading-loose text-white">Ilmu Kedokteran</p>
                    </div>
                    <div class="grid grid-cols-3 mx-auto">
                        <p class="text-3xl font-semibold leading-loose text-center text-white">Penjuruan<br />IPA</p>
                        <p class="text-3xl font-semibold leading-loose text-center text-white">Pelajaran Terkait<br />Kedokteran</p>
                        <p class="text-3xl font-semibold leading-loose text-center text-white">Kategori Jurusan<br />Kesehatan</p>
                    </div>
                </div>
            </section>
            <div class="pt-12 px-24">
                <div class="mt-12 flex items-center justify-center px-9 py-6 bg-blue-400 rounded-full mx-auto " style={{ width: 500, height: 50, }}>
                    <p class="text-2xl font-bold text-center text-white">Apa itu Ilmu Kedokteran?</p>
                </div>
                <blockquote class="py-8 bg-white rounded-2xl px-5">
                    <p class="text-lg text-center " >Ilmu Kedokteran adalah silmu yang mempelajari 
                    anatomi tubuh manusia dan bagaimana cara kerjanya, diagnosis, pemeliharaan kesehatan, 
                    pencegahan serta pengobatan penyakit manusia.</p>
                </blockquote>

                <div class="mt-12 flex items-center justify-center px-9 py-6 bg-blue-400 rounded-full mx-auto " style={{ width: 500, height: 50, }}>
                    <p class="text-2xl font-bold text-center text-white">Kenapa Ilmu Kedokteran?</p>
                </div>
                <blockquote class="py-8 bg-white rounded-2xl">
                    <p class="text-lg text-center mx-12" >peran Ilmu Kedokteran begitu penting dan vital, 
                    maka gak mengherankan jika proses 
                    untuk menjadi dokter memerlukan waktu yang cukup panjang.</p>
                </blockquote>
                ...
                <blockquote class="grid grid-cols-2 py-8 bg-white rounded-2xl">
                    <p class="text-lg px-20 my-1" >1. Etika Kedokteran </p>
                    <p class="text-lg px-20 my-1" >5. Biologi Kedokteran</p>
                    <p class="text-lg px-20 my-1" >2. Patologi Anatomi</p>
                    <p class="text-lg px-20 my-1" >6. Empathy and Social Accountability</p>
                    <p class="text-lg px-20 my-1" >3. Keterampilan Medis</p>
                    <p class="text-lg px-20 my-1" >7. Geowth and Development</p>
                    <p class="text-lg px-20 my-1" >4. Sistem Muskuloskeletal</p>
                </blockquote>

                <div class="mt-12 flex items-center justify-center px-9 py-6 bg-blue-400 rounded-full mx-auto " style={{ width: 500, height: 50, }}>
                    <p class="text-2xl font-bold text-center text-white">Profesi Lulusan Ilmu Kedokteran</p>
                </div>
                <blockquote class=" py-8 bg-white rounded-2xl">
                    <div class="grid grid-cols-4 ">
                        <div class="grid grid-rows-2 ">
                            <p class=" text-medium font-medium text-center">Dokter</p>
                            <img src={foto} class="w-32 h-32 object-cover -mt-12 mx-auto bg-black bg-opacity-30 rounded-full " />
                        </div>
                        <div class="grid grid-rows-2 ">
                            <p class=" text-medium font-medium text-center">Peneliti</p>
                            <img src={foto1} class="w-32 h-32 -mt-12 mx-auto object-cover bg-black bg-opacity-30 rounded-full" />
                        </div>
                        <div class="grid grid-rows-2 ">
                            <p class=" mb-4text-medium font-medium text-center">Ahli Epidemiologi</p>
                            <img src={foto2} class="w-32 h-32 -mt-12 mx-auto object-cover bg-black bg-opacity-30 rounded-full" />
                        </div>
                        <div class="grid grid-rows-2">
                            <p class="  text-medium font-medium text-center">Manajer Data Klinis</p>
                ...
                <div class="pb-12">
                    ...
                    <blockquote class=" py-12 bg-white rounded-2xl">
                        <div class="grid grid-cols-4">
                            ...
                            <div class="grid grid-rows-2 ">
                                <p class=" text-medium font-medium text-center">Universitas Padjadjaran</p>
                            ...
                            <div class="grid grid-rows-2">
                                <p class="  text-medium font-medium text-center">Universitas Gadjah Mada</p>
