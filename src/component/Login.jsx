...
import PKM1 from './foto/PKM1.png';
      ...
      <div class="container mx-auto">
        <div class="flex w-8/12 bg-white rounded-[70px] mx-auto shadow-lg overflow-hidden">
          <div class="w-1/2  bg-gradient-to-r from-cyan-500 to-blue-500">
            <img src={PKM1} class="h-64 w-64 mx-auto mt-28" />
            <h1 class="text-center text-white text-lg mt-8 font-bold">Let's Get Started</h1>
          </div>
          <div class="w-1/2 py-17 px-12">
            <h2 class="text-center mb-9 mt-16 text-[30px] text-[#5DA7DB] font-bold">Student Login</h2>
            <form onSubmit={handleSubmit}>
              ...
              <div class="mb-2 mt-2 text-gray-500 text-xs hover:text-gray-600 cursor-pointer">
                <p>Forgot password?</p>
              </div>
              <div class="mt-7">
                <button class="w-full bg-[#5DA7DB] hover:bg-[#4385b4] py-2 rounded-xl text-white font-bold text-lg">Login</button>
              </div>
              <div class="mb-2 mt-8 text-gray-500 text-xs text-center">
                <p>Or Sign In With</p>
              </div>
              ...
              <a href="/Register">
                <div class="mb-7 mt-8 text-[#5DA7DB] hover:text-[#4385b4] text-sm text-center font-bold underline underline-offset-2 cursor-pointer">
                  <p>Create Account</p>
                </div>
              </a>
            </form>
