import foto from './foto/ekonomi.jpg'
import foto1 from './foto/manajemen.jpg'
import foto2 from './foto/bisnis.jpg'
import foto3 from './foto/adm-publik.jpg'

function DetailProfesi3() {
    return (
        <div class="bg-gray-100 h-full  ">
            <section class="bg-gray-100 w-full h-screen bg-[url('./component/foto/Akuntan.png')] bg-[length:1300px_790px] bg-no-repeat overflow-hidden ">
                ...
                <div class="grid grid-rows-2 justify-center mt-20">
                    <div class="inline-flex space-x-4 items-center mx-auto">
                        ...
                        <p class="text-5xl font-bold leading-loose text-white">Akuntan</p>
                    </div>
                    <div class="grid grid-cols-3 mx-auto">
                        ...
                        <p class="text-3xl font-semibold leading-loose text-center text-white">Kategori<br />Ekonomi dan Bisnis</p>
                    </div>
                </div>
            </section>
            <div class="pt-12 px-24">
                <div class="mt-12 flex items-center justify-center py-6 bg-blue-400 rounded-full mx-auto " style={{ width: 500, height: 50, }}>
                    <p class="text-2xl font-bold text-center text-white">Apa itu Akuntan?</p>
                </div>
                <blockquote class="py-8 bg-white rounded-2xl">
                    <p class="text-lg text-center " >akuntan membuat catatan keuangan suatu perusahaan. 
                    Akuntan dapat bekerja untuk pemerintah, perusahaan, atau organisasi. 
                    Akuntan menyiapkan laporan keuangan seperti perpajakan, 
                    dan memastikan pajak dibayarkan tepat waktu.<br /></p>
                </blockquote>
                ...
                <blockquote class="py-8 bg-white rounded-2xl">
                    <p class="text-lg text-justify mx-12" >Tugas dan tanggung jawab utama seorang akuntan adala membuat dan 
                    mengelola laporan keuangan setiap periode perusahaan</p>
                </blockquote>
