...
function DetailKampus2 (){
    return(
      <div>
        <section class="bg-gray-100 w-full h-screen bg-[url('./component/foto/UI1.png')] bg-[length:1500px_720px] bg-no-repeat overflow-hidden ">
          <div class=" pl-24 pt-14 mt-96 sm:text-left grid grid-cols-1 gap-2">
            ...
            <h3 class=" text-3xl font-bold text-white">UI</h3>
          </div>
        </section>
            ...
            <div class="mt-5 grid grid-cols-3 gap-10 px-10 ">
              <div>
                <blockquote class="bg-gradient-to-r from-blue-900 to-blue-600 px-5 py-20 rounded-3xl">
                  ...
                  <p class="text-center text-white text-2xl font-semibold mt-8 my-4">Tahun didirikan: 1849</p>
              ...
              <div>
                <blockquote class="bg-gradient-to-r from-green-400 to-cyan-400 px-5 py-16 rounded-3xl">
                  ...
                  <div>
                    <p class="text-center text-white text-4xl font-bold mt-8">14</p>
                    <p class="text-center text-white text-xl">Fakultas</p>
                    <p class="text-center text-white text-4xl font-bold mt-4">291</p>
              ...
              <div>
                <blockquote class="bg-gradient-to-r from-blue-600 to-blue-900 px-5 py-20 rounded-3xl">
                  ...
                  <div>
                    <p class="text-center text-white text-4xl font-bold mt-10">2379</p>
                    <p class="text-center text-white text-xl">Dosen</p>
                    <p class="text-center text-white text-4xl font-bold mt-12">47.641</p>
                  ...
                  <blockquote class="bg-white rounded-3xl py-20">
                    ...
                    <div class="bg-gray-100 shadow rounded-3xl mx-auto" style={{width: 500, height: 250,}}> 
                      ...
                      <p class="text-lg text-center text-black mt-8 mx-auto px-4">
                        Lihat selengkapnya persentasi selektivitas di jurusan Universitas Indonesia. 
            ...
            <div class="mt-5 grid grid-cols-2 gap-10 px-20">
              ...
              <div>
                <blockquote class="bg-gray-100 rounded-3xl mx-auto mt-10"style={{width: 510, height: 549,}}>
                  <div className="mx-auto w-32 h-32 bg-white shadow rounded-full">
                    <img className="mt-4 mx-auto p-auto" src={logoui} alt=""/>
                  </div> 
                  <div>
                    <p class="mx-14 mt-24 text-xl font-semibold">Jenis Seleksi : Mandiri UI</p>
                    <p class="mx-14 mt-4 text-xl font-semibold">Waktu Pelaksanaan : -</p>
                  ...
                  <div class="mx-60">
                    <div class="mt-14 w-56 h-16 bg-gradient-to-r from-cyan-500 to-cyan-400 shadow rounded-full">
                      <a href="https://penerimaan.ui.ac.id/">
                      <button class="hover:scale-105 mx-2">
                        <p class="mx-auto pt-3 w-48 h-9 text-2xl font-bold text-center text-white">Selengkapnya</p>
                      </button>
                      </a>
        ...
        <section class="bg-gray-100">
          <div class = "p-5">
            ...
            <p class="text-lg text-black text-center">
              Biaya kuliah di Universitas  Indonesia tidak hanya dibedakan berdasarkan 
              jenis masuk dan fakultas saja, namun berdasarkan golongan. UI telah menganut 
              ...
              <div>
                <div class="max-w-xl text-center sm:text-left mx-24">
                  ...
                  <p className="text-lg text-gray-900 mt-5">
                    Alamat : Pondok Cina, Kecamatan Beji, Kota Depok, Jawa Barat 16424<br/>
                    Nomor Telepon : (021) 7270020<br/>
                    Website : http://ui.ac.id/<br/>
                    E-Mail : humas-ui@ac.id<br/></p>
                </div>
              </div>
              <a href="https://www.google.com/maps/place/University+of+Indonesia/@-6.2825047,106.7671243,12z/data=!4m10!1m2!2m1!1sui!3m6!1s0x2e69ec1a804e8b85:0xd7bf80e1977cea07!8m2!3d-6.3606229!4d106.8272343!15sCgJ1aSIDiAEBWgQiAnVpkgEKdW5pdmVyc2l0eZoBI0NoWkRTVWhOTUc5blMwVkpRMEZuU1VSVGFHVTNiR1JCRUFF4AEA!16zL20vMDF6bHJ2">
              <img
                alt=" "
                src={imgD}
