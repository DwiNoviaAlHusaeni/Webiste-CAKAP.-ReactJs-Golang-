...
import logoupi from './foto/img/logoupi.png';
...
function DetailKampus (){
    return(
      <div>
        <section class="bg-gray-100 w-full h-screen bg-[url('./component/foto/img/UPI.png')] bg-[length:1500px_720px] bg-no-repeat overflow-hidden ">
          <div class=" pl-24 pt-14 mt-96 sm:text-left grid grid-cols-1 gap-2">
            ...
            <h3 class=" text-3xl font-bold text-white">UPI</h3>
          </div>
        </section>
            ...
            <div class="mt-5 grid grid-cols-3 gap-10 px-10 ">
              <div>
                <blockquote class="bg-gradient-to-r from-blue-900 to-blue-600 px-5 py-20 rounded-3xl">
                  ...
                  <p class="text-center text-white text-2xl font-semibold mt-8 my-4">Tahun didirikan: 1954</p>
              ...
              <div>
                <blockquote class="bg-gradient-to-r from-blue-600 to-blue-900 px-5 py-20 rounded-3xl">
                  ...
                  <div>
                    <p class="text-center text-white text-4xl font-bold mt-10">813</p>
                    <p class="text-center text-white text-xl">Dosen</p>
                    <p class="text-center text-white text-4xl font-bold mt-12">25.252</p>
                  ...
                  <blockquote class="bg-white rounded-3xl py-20">
                    ...
                    <div class="bg-gray-100 shadow rounded-3xl mx-auto" style={{width: 500, height: 250,}}> 
                      ...
                      <p class="text-lg text-center text-black mt-8 mx-auto px-4">
                        Lihat selengkapnya persentasi selektivitas di jurusan Universitas Pendidikan Indonesia. 
            ...
            <div class="mt-5 grid grid-cols-2 gap-10 px-20">
              ...
              <div>
                <blockquote class="bg-gray-100 rounded-3xl mx-auto mt-10"style={{width: 510, height: 549,}}>
                  <div className="mx-auto w-32 h-32 bg-white shadow rounded-full">
                    <img className="mt-4 mx-auto p-auto" src={logoupi} alt=""/>
                  </div> 
                  <div>
                    <p class="mx-14 mt-24 text-xl font-semibold">Jenis Seleksi : Mandiri UPI</p>
                    <p class="mx-14 mt-4 text-xl font-semibold">Waktu Pelaksanaan : -</p>
        ...
        <section class="bg-gray-100">
          <div class = "p-5">
            ...
            <p class="text-lg text-black text-center">
              Biaya kuliah di Universitas Pendidikan Indonesia tidak hanya dibedakan berdasarkan 
              jenis masuk dan fakultas saja, namun berdasarkan golongan. UPI telah menganut 
              ...
              <div>
                <div class="max-w-xl text-center sm:text-left mx-24">
                  ...
                  <p className="text-lg text-gray-900 mt-5">
                    Alamat : Jl. Dr. Setiabudhi 229, Bandung, Jawa Barat, 40154<br/>
                    Nomor Telepon : (022) 2013161<br/>
                    Website : http://www.upi.edu<br/>
                    E-Mail : info@upi.edu<br/></p>
                </div>
              </div>
              <a href="https://www.google.com/maps/place/Universitas+Pendidikan+Indonesia/@-6.8611339,107.5943499,15z/data=!4m2!3m1!1s0x0:0xee36226510a79e76?sa=X&ved=2ahUKEwjvgpuWsaH8AhWkm9gFHaX2AIoQ_BJ6BAhfEAg">
              <img
                alt=" "
                src={imgD}
